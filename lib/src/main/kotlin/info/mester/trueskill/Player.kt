...
data class Player(
     ...
     */
    fun withRating(newRating: Rating): Player {
     ...
     */
    fun withPartialPlay(percentage: Double): Player {
        return copy(partialPlayPercentage = percentage)
    }
    
    override fun toString(): String {
        return "Player(id='$id', rating=$rating, partialPlay=${"%.2f".format(partialPlayPercentage)})"
    }
}
